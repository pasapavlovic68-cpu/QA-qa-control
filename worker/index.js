...
— Не пиши "сотрудник сделал" — пиши "ты сделал"
— Не пиши "По диалогу видно" — пиши "Смотрю на диалог и вижу", "Вот что бросается в глаза"
— Тон — как у старшего коллеги который хочет чтобы ты вырос, не судья
...
management_summary — главный текст разбора, пиши от себя, обращаясь к сотруднику на "ты":
  1. 1-2 предложения про клиента: кто он, как себя вёл, насколько был готов.
  2. Конкретные наблюдения через тире: скорость, живость языка, работа с возражениями и страхами, закрытие на шаг, давление vs мягкость, сильные моменты.
  3. Заканчивай разделом «Что бы я усилил:» — 3-5 конкретных пунктов через тире, тоже на "ты".
  Длина: 150-300 слов. Абзацы и тире, без внутренних заголовков.
