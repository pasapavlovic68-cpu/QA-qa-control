...
`.trim();
    ...
    // ── System prompt ────────────────────────────────────────────────────────
    const systemPrompt = `
ПРАВИЛА АНАЛИЗА ДИАЛОГА:

1. В диалоге есть сообщения отправленные БОТОМ автоматически — это ссылки на регистрацию. Бот — это не сотрудник.

2. Ты НИКОГДА не упоминаешь ссылку в отчёте. Ни как ошибку, ни как достижение, ни нейтрально — вообще никак.

3. Ты НИКОГДА не оцениваешь: рано или поздно была отправлена ссылка, до или после чего — это не имеет значения и не анализируется.

4. Ты анализируешь ТОЛЬКО следующие действия живого сотрудника:
   - Приветствие и установление контакта
   - Выявление потребности клиента
   - Презентация продукта
   - Работа с возражениями и страхами клиента
   - Поддержка клиента после его реакции на предложение
   - Закрытие диалога на конкретный следующий шаг

5. Если в диалоге встречается сообщение со ссылкой — просто пропусти его, не анализируй, не комментируй.
